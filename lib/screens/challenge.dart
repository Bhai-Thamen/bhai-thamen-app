                ...
                Container(
                  ...
                  borderRadius: BorderRadius.circular(10), 
                    ...
                    child:                        
                        ...
                        Flexible(child: AutoSizeText(languages[selectedLanguage[languageIndex]]['doShare'], maxLines:2, style: myStyle(18), textAlign: TextAlign.left,)):
                        Flexible(child: AutoSizeText(languages[selectedLanguage[languageIndex]]['notShare'], maxLines:2, style: myStyle(18), textAlign: TextAlign.left,))
     ...
     // Column(children:[
        ...
        SizedBox(height:30),
            ButtonTheme(
              ...
              child: RaisedButton(
                onPressed:(){
                  analyticsHelper.sendAnalyticsEvent('Challenge_Screen_Select', param:challengeOptions[i]);
                  sendResearchReport('Challenge_Screen_Select_'+challengeOptions[i]); 
                  Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ChallengeScreen(challengeOptions[i], userData, i),
                          ),
                        );
                },
               // padding: EdgeInsets.only(left: MediaQuery.of(context).size.width/4, right: MediaQuery.of(context).size.width/4, top: 15, bottom:15),
                color:challengeRecordSendSMS? Colors.red[400] :Colors.grey[600],
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(18.0),
                  //side: BorderSide(color: Colors.red, width:4)
                ),
                child: Text(challengeOptions[i], style: myStyle(26, Colors.white),),
                ),
            ),
          ],
        ),
