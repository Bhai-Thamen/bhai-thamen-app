  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        Row(
          ...
          children: [
            Spacer(),
          Text('Timer', style: myStyle(26),),
          Spacer(),
          Text('Interval', style: myStyle(26),),        
          Spacer(),
        ],
        ),
          ...
          Container(
              ...
              DropdownButton(
                ...
                items: [
                    DropdownMenuItem(
                    child:  
                    Text("10 sec", style: myStyle(18)                    
                    ),                  
                    value: 10,
                  ),
                  DropdownMenuItem(
                    child:  
                    Text("5 mins", style: myStyle(18)                    
                    ),                  
                    value: 300,
                  ),
                 DropdownMenuItem(
                    child:  
                    Text("10 mins", style: myStyle(18)                    
                    ),                  
                    value: 600,
                  ),
                 DropdownMenuItem(
                    child:  
                    Text("20 mins", style: myStyle(18)                    
                    ),                  
                    value: 1200,
                  ),
                 DropdownMenuItem(
                    child:  
                    Text("30 mins", style: myStyle(18)                    
                    ),                  
                    value: 1800,
                  ),                                                      
                 DropdownMenuItem(
                    child:  
                    Text("60 mins", style: myStyle(18)                    
                    ),                  
                    value: 3600,
                  ),                                 
        ...
        Container(
              ...
              DropdownButton(
                ...
                items: [
                  DropdownMenuItem(
                    child:  
                    Text("1 min", style: myStyle(18)                    
                    ),                  
                    value: 10,
                  ),
                 DropdownMenuItem(
                    child:  
                    Text("2 mins", style: myStyle(18)                    
                    ),                  
                    value: 120,
                  ),
                 DropdownMenuItem(
            ...
            if (earlyQuit && time!=null){
              ...
              if (myTimeRemaining.hours==null){
                 return Text(               
                  ...
                  , style:myStyle(30));
              } else if (myTimeRemaining.hours==null && myTimeRemaining.min==null){
                 return Text( 
                 '00'
                  +'00'
                  +':'+myTimeRemaining.sec.toString().padLeft(2, "0")
              ...
              Container(
                ...
                child: InkWell(
                  onTap:() {
                    ...
                    setState(() {
                      if (resetValue==true){
                      endTime = DateTime.now().millisecondsSinceEpoch + 1000 * askTime;
                      resetValue=false;
                      }else{
                      int hourSeconds = myTimeRemaining.hours!=null ? myTimeRemaining.hours*3600 : 0;
                      int minuteSeconds =  myTimeRemaining.min!=null ? myTimeRemaining.min*60 : 0;
                      int seconds = myTimeRemaining.sec;
                      int allSeconds = hourSeconds+minuteSeconds+seconds;
                      print ('tiem remain sec '+allSeconds.toString());
                      endTime=allSeconds;
                      }
                  ...
                  child: askTimerRunning ? Image.asset('assets/images/stopTimer.png'):Image.asset('assets/images/timerStart.png')
                  ),
              ), 
              Spacer(),             
            ],
