...
class _LoginState extends State<Login> {
  ...
  bool termsAccepted = false;
   ...
   final AuthService _authPage = AuthService();
...
if (connectivityResult == ConnectivityResult.mobile) {
  ...
  return false;
    ...
    return showDialog(
          context: context,
          child: AlertDialog(
            title: Text(languages[selectedLanguage[languageIndex]]['needInternetTitle']),
            content: 
      Container(
        height: 180,
        width:320,
        child: Center(child:
        Column(children: [
          Text(languages[selectedLanguage[languageIndex]]['needInternetDesc'], style: myStyle(20, Colors.red, FontWeight.w400)),
          SizedBox(height:30),
          Row(
          ...
          Spacer(),
          FlatButton(
                    child: Text(languages[selectedLanguage[languageIndex]]['ok'], style: myStyle(14, Colors.white)),
...
//      validNumber=true;
    ...
    initialiseData(auth.User user, String phone)async{
      ...
      print ('userdata state '+userDoc.exists.toString());
    ...
    try{
      ...
      print ('logged in and top part'+user.uid);
      ...
      return null;
        ...
        codeSent: (String verificationId, [int forceResendingToken]){
          showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                title: Text(languages[selectedLanguage[languageIndex]]['enterCode']),
                content: Column(
                ...
                actions: <Widget>[
                  Row(
                    ...
                    children:[
                    FlatButton(
                    child: Text(languages[selectedLanguage[languageIndex]]['cancel']),
                    textColor: Colors.white,
                    color: Colors.red,
                    onPressed: () async{
                      Navigator.pop(context);
                  ...
                  SizedBox(width: 100),
                  FlatButton(
                    child: Text(languages[selectedLanguage[languageIndex]]['confirm']),
                    textColor: Colors.white,
                    color: Colors.green,
                    onPressed: () async{
                      ...
                      try{
                        print ('logged in and afetr confirm');
                        auth.UserCredential result = await _auth.signInWithCredential(credential);
                        auth.User user = result.user;
                        await initialiseData(user, phone);
  ...
  Future<bool> _terms(BuildContext context) {
    ...
    return showDialog(
          ...
          child: AlertDialog(
            ...
            title: Center(child: Text(languages[selectedLanguage[languageIndex]]['terms'])),
                   ...
                   SizedBox(
                    ...
                    Row(
                      ...
                      RaisedButton(
                        ...
                        child: Text(languages[selectedLanguage[languageIndex]]['accept'])
                        ),
                      Spacer(),                                 
                    ],
                    ),
      ...
      body: SingleChildScrollView(
          ...
          child: Column(
            ...
            child: InternationalPhoneInput(
              ...
              errorText: languages[selectedLanguage[languageIndex]]['invalidNumber'],
              errorStyle: myStyle(14, Colors.red[300], FontWeight.w700),
              labelText: languages[selectedLanguage[languageIndex]]['enterNumber'],
            ...
            InkWell(
              ...
              child: Center( 
                child:Text(languages[selectedLanguage[languageIndex]]['loginBtn'], style: myStyle(20, Colors.black, FontWeight.w700)
                ),
              ),
              ),
            ),
            ...
            Row(
              ...
              Container(
                width: MediaQuery.of(context).size.width*0.8,
                child: Text(languages[selectedLanguage[languageIndex]]['whatIs'], maxLines:2, textAlign: TextAlign.center ,style: myStyle(20, Colors.white,FontWeight.w400))),
              ...
              InkWell(
                onTap: ()=>_launchURL(),
                child: Text('www.bhaithamen.com', style: myStyle(20, Colors.white, FontWeight.w500))
                ), 
