...
@override
  Widget build(BuildContext context) {
    ...
    return userData==null ? Center(child:CircularProgressIndicator()) :
    Container(
...
Container(
    ...
    child: Card(
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              SizedBox(height:12),
                              userData.userName==''?Text('username',style:myStyle(22, Colors.black87, FontWeight.w300)):
                              Text(userData.userName,
                                  style: myStyle(22, Colors.black, FontWeight.w400),
                                    ),
                              SizedBox(height:12),
                            userData.email==''?Text('email',style:myStyle(18, Colors.black87, FontWeight.w300)):
                              Text(userData.email,
              ...
              ListTile(
                ...
                title: Text('My Profile & Trusted Contacts', style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text('App Events', style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),
              ListTile(
                onTap: (){
                ...
                title: Text('Submitted Reports', style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),
              ListTile(
                onTap: (){
                ...
                title: Text('Pick Secret Screen', style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),              
              SizedBox(height:5),
              ...
              ListTile(
                ...
                title: Text('Sign Out', style: myStyle(18, Colors.black, FontWeight.w400),),
