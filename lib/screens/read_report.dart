...
setUpEventsList(){
  ...
  //formatDate(DateTime.parse(report.eventDate), [d, ' ', MM, ' ', yyyy])
      ...
      selectedEvents =  widget.theEventsList.where((report) => formatDate(DateTime.parse(report.eventDate), [d, ' ', MM, ' ', yyyy]) == widget.reportData.incidentDate).toList();
      ...
      for (var i=0; i<selectedEvents[0].allEvents.length; i++){
        if (widget.reportData.attachedEvents.contains(selectedEvents[0].allEvents[i].eventId)){
  ...
  final SafePageIndex safePageIndex = Provider.of<SafePageIndex>(context);
    ...
    return Scaffold(
        ...
        appBar: AppBar(
        title: testModeToggle ? Text(languages[selectedLanguage[languageIndex]]['testOn'], style: myStyle(18, Colors.white)): Text('Bhai Thamen', style: myStyle(18, Colors.white)),  
                          ...
                          flex: 6,
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image:  AssetImage('assets/images/'+widget.reportData.type.replaceAll(' ', '').toLowerCase()+'Icon.png'),
                                        fit: BoxFit.fitWidth),
                                      ),
                            ),
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                SizedBox(height:2),
                              Text(languages[selectedLanguage[languageIndex]][widget.reportData.type], style: myStyle(18)),                            
                                SizedBox(height:8),
                              Text(languages[selectedLanguage[languageIndex]][widget.reportData.target], style: myStyle(18)),                            
                                SizedBox(height:8),                              
                              Text(widget.reportData.incidentDate, style: myStyle(16)),
                                SizedBox(height:8),
                              Text(languages[selectedLanguage[languageIndex]]['reportId']+widget.reportData.reportUid, style: myStyle(16)),                            
                              Spacer(
                                flex: 3,
                              ), 
  ...
  Column(
    ...
    children: [
    Text(languages[selectedLanguage[languageIndex]]['incidentLocation'], style: myStyle(20, Colors.black, FontWeight.w600)),
    SizedBox(height:8),
    Text(widget.reportData.location, style: myStyle(20)),
    SizedBox(height:14),
    Divider(thickness:1, color:Colors.black54, indent: 5, endIndent: 5),
    Text(languages[selectedLanguage[languageIndex]]['incidentDescription'], style: myStyle(20, Colors.black, FontWeight.w600)),
    SizedBox(height:8),
    Text(widget.reportData.description, style: myStyle(18)),
    SizedBox(height:4),
    Divider(thickness:1, color:Colors.black54, indent: 5, endIndent: 5),
    SizedBox(height:4),
    foundEvents.length>0 ? Text(languages[selectedLanguage[languageIndex]]['associatedEvents'], style: myStyle(20, Colors.black, FontWeight.w600),textAlign: TextAlign.center) : Text(languages[selectedLanguage[languageIndex]]['noAssociatedEvents'], style: myStyle(20, Colors.black, FontWeight.w600), textAlign: TextAlign.center,),
    SizedBox(height:8),
  ]
   ...
   for (var i=0; i<foundEvents.length; i++)
          ...
          padding: EdgeInsets.symmetric(vertical:1.0, horizontal:4.0),        
              ...
              child: ListTile(              
                ...
                isThreeLine: true,
                leading: Image.asset('assets/images/'+foundEvents[i].type+'Icon.png'),
                title: Text(languages[selectedLanguage[languageIndex]][foundEvents[i].type], style: myStyle(18)),
                subtitle: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children:[
                Text(formatDate(foundEvents[i].time, [d, ' ', MM, ' ', yy, ' at ', HH, ':', nn])),
                Text('LAT: '+foundEvents[i].location.latitude.toString()+' LONG: '+foundEvents[i].location.longitude.toString()),
                ],
                ),
