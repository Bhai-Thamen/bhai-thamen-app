...
final ImagePicker _picker = ImagePicker();
  ...
  final String fileName = basename(pickedImage.path); // Filename without extension
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(languages[selectedLanguage[languageIndex]]['secretInstructions'], style: myStyle(20), textAlign: TextAlign.center),
              ),
              SizedBox(height:20),
              InkWell(
                onTap: (){
                 ...
                 pickImage(ImageSource.gallery);
                  ...
                  child: AspectRatio(
                      aspectRatio: 9 / 16,
                      child: Image(
                        image: imageFile != null ? FileImage(File(pickedImagePath)) :
              ...
              SizedBox(height:15),
                RaisedButton(
                  ...
                  child: Text(languages[selectedLanguage[languageIndex]]['useDefault'], style: myStyle(18, Colors.white),),
                ),
