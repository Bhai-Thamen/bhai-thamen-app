...
class _DeleteAccountState extends State<DeleteAccount> {
  ...
  _submitDelete() async {
    ...
    if (checkConfirm == true) {
      ...
      String getMyDate = getDate().toString();
      ...
      await userCollection
          ...
          .then((doc) {
            requestedDeleteAccount
                ...
                .then((doc) async {
                  analyticsHelper
                      .sendAnalyticsEvent('Account_Delete_Requested');
                  //await sendResearchReport('Account_Delete_Requested');
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            children: [
              SizedBox(height: 18),
              Text(languages[selectedLanguage[languageIndex]]['deleteAccount'],
