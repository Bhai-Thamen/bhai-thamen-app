 ...
 @override
  void initState() {
    ...
    return showDialog(
          context: context,
          child: AlertDialog(
            title: Text(languages[selectedLanguage[languageIndex]]['checkSignOut1']),
            content: 
      Container(
        height: 180,
        width:320,
        child: Center(child:
        Column(children: [
          Text(languages[selectedLanguage[languageIndex]]['checkSignOut2'], style: myStyle(20, Colors.red, FontWeight.w400)),
          SizedBox(height:30),
          Row(
          ...
          Spacer(),
          FlatButton(
                    child: Text(languages[selectedLanguage[languageIndex]]['stay'], style: myStyle(14, Colors.white)),
          ...
          SizedBox(width:14),
          FlatButton(
                    child: AutoSizeText(languages[selectedLanguage[languageIndex]]['signOut'],  maxLines:2, style: myStyle(14, Colors.white)),
                    textColor: Colors.white,
                    color: Colors.green,
                    onPressed: () async{
   ...
   final SafePageIndex safePageIndex = Provider.of<SafePageIndex>(context);
    ...
    resizeToAvoidBottomInset: false,
      appBar: AppBar(
        ...
        //             image: AssetImage('assets/images/handStop.jpg'),
        ...
        actions: <Widget>[
          ...
          FlatButton(
            ...
            Row(
              children:[
            testModeToggle ? Text(languages[selectedLanguage[languageIndex]]['testOn'], style: myStyle(18, Colors.white)): Text(languages[selectedLanguage[languageIndex]]['testOff'], style: myStyle(18, Colors.white)),    
            Switch(              
...
Container(
    ...
    child: Card(
                      ...
                      Expanded(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                               shape: BoxShape.circle,  
                               image: DecorationImage(
                                   image: userData.profilePic=='default' ? AssetImage('assets/images/defaultAvatar.png'):
                                    NetworkImage(
                                       userData.profilePic),
                                   fit: BoxFit.fill),
                                  ),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              SizedBox(height:12),
                              userData.userName==''?AutoSizeText(languages[selectedLanguage[languageIndex]]['username'],maxLines:1,style:myStyle(18, Colors.black87, FontWeight.w300)):
                              AutoSizeText(userData.userName,maxLines:1,
                                  style: myStyle(22, Colors.black, FontWeight.w400),
                                    ),
                              SizedBox(height:12),
                            userData.email==''?AutoSizeText(languages[selectedLanguage[languageIndex]]['email'],maxLines:1, style:myStyle(16, Colors.black87, FontWeight.w300)):
                              AutoSizeText(userData.email,maxLines: 1,
              ...
              ListTile(
                ...
                title: AutoSizeText(languages[selectedLanguage[languageIndex]]['setProfile'], maxLines:1, style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setEvents'], style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),
              ListTile(
                onTap: (){
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setReports'], style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),
              ListTile(
                onTap: (){
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setSecret'], style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Icon(Icons.arrow_forward),
              ),              
              ListTile(
                onTap: (){
                    },       
                title: Text(languages[selectedLanguage[languageIndex]]['setLanguage'], style: myStyle(18, Colors.black, FontWeight.w400),),
              trailing: Switch(              
            ...
            setState(() {
              ...
              if (_isEnglish==true){
                languageIndex=0;
                _saveLanguage();
                analyticsHelper.sendAnalyticsEvent('Use_English');
                sendResearchReport('Use_English');
              }else{
                languageIndex=1;
                _saveLanguage();
                analyticsHelper.sendAnalyticsEvent('Use_Bangla');
            ...
            //   ),                             
              SizedBox(height:5),
              Divider(indent: 15.0, endIndent:15.0, thickness:3.0, color:Colors.black54 ),
              ListTile(
                onTap: (){
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['tutorialPage'], style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setFeedback'], style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['deleteData'], style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setDelete'], style: myStyle(18, Colors.black, FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text(languages[selectedLanguage[languageIndex]]['setSignOut'], style: myStyle(18, Colors.black, FontWeight.w400),),
