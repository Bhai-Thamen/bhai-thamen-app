    ...
    Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              //Text("Welcome to Family Time", style: myStyle(18, Colors.white, FontWeight.w600)),
            SizedBox(height:10),
            Text(
            ...
            InkWell(
              ...
              child: Center( 
                child:Text('Register', style: myStyle(20, Colors.black, FontWeight.w700)
                ),
              ),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text('Terms and Policies', style: myStyle(18, Colors.purple, FontWeight.w700)))
              ],)
            ],
            ),
          ),
