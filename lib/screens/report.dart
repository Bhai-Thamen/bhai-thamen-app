  ...
  _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate)
      setState(() {
        ...
        // if (allEvents!=null){
        //     print ('ae non null' );
        //     filterEvents =  allEvents.where((event) => event.eventDate == searchDate).toList();
        //     if (filterEvents!=null){
        //     if (filterEvents.length==1){
        //       print ('FD '+filterEvents.toString());
        //       eventsList.clear();
        //       EventDay theDay = filterEvents[0];
        //       print ('the say' +theDay.allEvents.toString());
        //       filterEvents.forEach((element) {

        //       });
        //       eventsList = filterEvents[0].allEvents;
        //        print ('match events  '+filterEvents[0].allEvents.length.toString());
        //     }else{
        //       eventsList.clear();
        //     }
        //     }
  ...
  Widget build(BuildContext context) {
    ...
    if (allEvents != null) {
      ...
      filterEvents.forEach((element) {
        ...
        foundDay = element;
        print(foundDay.allEvents.length.toString());
      });
    }
