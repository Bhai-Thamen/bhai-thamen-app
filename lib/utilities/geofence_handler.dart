...
import 'package:google_maps_flutter/google_maps_flutter.dart';
  ...
  int _loiteringDelay = 3000;
    ...
    bg.BackgroundGeolocation.addGeofence(bg.Geofence(
      ...
      print ('fence '+center.latitude.toString()+'    '+center.longitude.toString()+'  '+rad.toString());
    }).catchError((error) {
  ...
  removeAllGeofences()async{
    ...
    bg.BackgroundGeolocation.removeGeofence(fence.identifier).then((bool success) {
  ...
  removeACircle(String id, bool sound){
    ...
    if (sound) bg.BackgroundGeolocation.playSound(util.Dialog.getSoundId('CLOSE'));
    });
