...
//import 'package:bhaithamen/utilities/auto_page_navigation.dart' as auto;
...
askMeFlushBarShow() {
  ...
  Flushbar(
    ...
    mainButton: FlatButton(
      child: Text('YEP'),
      onPressed: () {
        print('Bet it didnt wrk');
        // al.setLocalHomePage(1);
      },
    ),
  ).show(globalContext);
}
