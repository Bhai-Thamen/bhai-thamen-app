...
dynamic pinProvider;
 ...
 @override
  ...
  if (secretRecordSendSMS ==null){secretRecordSendSMS=true;}  

    secretRecordCover = prefs.getBool('secretDummy');
  if (secretRecordCover ==null){secretRecordCover=false;}

   challengeRecordSendSMS = prefs.getBool('challengeSMS');
  if (challengeRecordSendSMS ==null){challengeRecordSendSMS=true;}  
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers:[
        ...
        ChangeNotifierProvider<AutoHomePageMapSelect>.value(value : AutoHomePageMapSelect(myVars.savedShouldGoMap)),
        ChangeNotifierProvider<AutoHomePageAskSelect>.value(value : AutoHomePageAskSelect(myVars.savedShouldGoAsk)),
        //ChangeNotifierProvider<PinRequired>.value(value : PinRequired(pinNeeded)),
        ChangeNotifierProvider<SafePageIndex>.value(value : SafePageIndex(myVars.savedSafeIndex)),
      ],   
    child: MaterialApp(
